...
/**
 * ECMA-269 12.2.17: This parameter type describes the connection state of the
 * device associated with the Monitor Cross Reference ID. This parameter type is
 * only applicable for events generated by device-type monitors. Format: This
 * parameter type shall contain one of the following connection states: -
 * alerting - connected - fail - hold - initiated - null - queued
 * 
 */
