...
/**
 * ECMA-269 12.3.21:  The MonitorCrossRefID parameter type specifies an identifier that is used to correlate an event to an
 * established monitor.  When a monitor is established using the Monitor Start service, a
 * monitor Cross ReferenceID parameter is returned as part of the positive acknowledgement message.  This
 * monitorCrossReferenceID parameter is included in every event for that specific monitor.
 *
 */
