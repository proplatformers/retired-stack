...
//            System.out.println("12April -- str.charAt("+Integer.toString(i)+") = " + Integer.toHexString( str.charAt(i))) ;
        //        char[] tmp_array = str.toCharArray() ;
        //        System.out.println("Length of array: " + Integer.toString(tmp_array.length)) ;
        //        for(int i = 0 ; i < tmp_array.length;i++)
        //            System.out.println("12April - Char array [" + Integer.toString(i) + "] = " + Integer.toHexString( tmp_array[i])) ;
        //
        //
        //        int[] show = new int[tmp_array.length] ;
        //        for(int i = 0 ; i < tmp_array.length ; i++) {
        //            if(tmp_array[i]<58)//48-57 = '0' - '9'.  0x30-0x39
        //                show[i] = (int)tmp_array[i] - 48 ;
        //            else if(tmp_array[i]>96)//a=97/0x61
        //                show[i] = (int)tmp_array[i] - 87 ;
        //
        //            System.out.println("April12 hahaha: " + Integer.toString(show[i])) ;
        //        }
        //        int number1 = (show[0]*16) + (show[1]) ;
        //        int number2 = (show[2]*16) + (show[3]) ;
        //        //            System.out.println(Integer.toHexString(number1) + " " + Integer.toHexString(number2) ) ;
        //        StringBuffer tmp = new StringBuffer() ;
        //        if( number1 !=0 )
        //            tmp = tmp.append( Integer.toHexString(number1) ).append( Integer.toHexString(number2) ) ;
        //        else
        //            tmp = tmp.append( Integer.toHexString(number2) ) ;
        //        String call_id = tmp.toString() ;
        return str ;
    }
    ...
    public String toLegibleString(String str){
        ...
        System.out.println( Integer.toHexString(str.charAt(0)) + Integer.toHexString(str.charAt(1))) ;
        for(int i = 0 ; i < str.length() ; i++){
    ...
    public StringBuffer Connection_ID2(StringBuffer sb){
        ...
        sb = sb.insert(0,(char)length).insert(0,SEQUENCE).insert(0,(char)(length+2)).insert(0,CONN_ID) ;
        return sb ;
    }
    ...
    public String Call_ID(String call_id_0) {
        ...
        System.out.println("length call_id:"+ Integer.toString(call_id.length()) + ":\n\t") ;
...
//      + 0x89, 0x03, 0x02, 0xFC, 0x18, 0x83, 0x02, 0x05, 0xC0, 0x85, 0x02, 0x01, 0xC0, 0x84, 0x02, 0x07, 0x00} ;
    ...
    /**
     * @param invoke_id_ref the invoke_id_ref to set
     */
